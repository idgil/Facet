...
void RunAction::CreateHistogram()
{
  ...
  //  analysisManager->CreateH1("Spec","Initial spectrum", 100, 0., 8.0*MeV);
    ...
    analysisManager->CreateNtupleIColumn("layerNo");
    analysisManager->CreateNtupleIColumn("pixelNo");
    analysisManager->CreateNtupleIColumn("lineNo");
    analysisManager->CreateNtupleDColumn("dE,keV");
    analysisManager->CreateNtupleDColumn("start_angz");
        analysisManager->CreateNtupleDColumn("start_angphi");
    analysisManager->CreateNtupleDColumn("pixel angz");
     analysisManager->CreateNtupleDColumn("pixel angphi");
